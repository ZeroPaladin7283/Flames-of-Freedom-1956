...
@NamedQueries({@NamedQuery(name = "Items.findAll", query = "SELECT i FROM Items i"), 
    ...
    @NamedQuery(name = "Items.findByDamage", query = "SELECT i FROM Items i WHERE i.damage = :damage"), 
    ...
    @NamedQuery(name = "Items.findByDeletedAt", query = "SELECT i FROM Items i WHERE i.deletedAt = :deletedAt")})
